...
const SOUNDS = {
	fire: {
		name: "Fire",
		icon: fireIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/2606/2606-preview.mp3",
	},
	crickets: {
		name: "Crickets",
		icon: cricketsIcon,
	...
	rainOnSurface: {
		...
		url: "https://assets.mixkit.co/active_storage/sfx/1779/1779-preview.mp3",
	},
	rain: {
		name: "Rain",
		icon: rainIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/1743/1743-preview.mp3",
	},
	birds: {
		name: "Birds",
		icon: birdsIcon,
	...
	insects: {
		name: "Insects",
		icon: insectsIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/1744/1744-preview.mp3",
	},
	chimes: {
		name: "Chimes",
		icon: chimesIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/1711/1711-preview.mp3",
	},
	cafe: {
		name: "Café",
		icon: cupIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/1747/1747-preview.mp3",
	},
	coffeeMaker: {
		name: "Coffee Maker",
		icon: coffeeMakerIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/1748/1748-preview.mp3",
	},
	thunder: {
		name: "Thunder",
		icon: thunderIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/1760/1760-preview.mp3",
	},
	loudRain: {
		name: "Loud Rain",
		icon: loudRainIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/1777/1777-preview.mp3",
	},
	stream: {
		name: "Stream",
		icon: streamIcon,
	...
	coWorkers: {
		name: "Co-workers",
		icon: coWorkersIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/1749/1749-preview.mp3",
	},
	copier: {
		name: "Copier",
		icon: copierIcon,
		url: "https://assets.mixkit.co/active_storage/sfx/1755/1755-preview.mp3",
	},
	airConditioner: {
	...
	mechanicalKeyboard: {
		...
		url: "https://assets.mixkit.co/active_storage/sfx/1758/1758-preview.mp3",
	},
};
